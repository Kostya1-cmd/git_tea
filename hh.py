...
player1 = Player("hero.png", 10, 440, 10)
enemy1 = Enemy("cyborg.png", 600, 300, 1)
treasure = GameSprate("treasure.png", 600, 440, 0)

w1 = Wall(154, 205, 50, 100, 20, 450, 10)
w2 = Wall(154, 205, 50, 100, 480, 350, 10)
w3 = Wall(154, 205, 50, 100, 20, 10, 380)
w4 = Wall(154, 205, 50, 100, 480, 450, 30)
...
while game:
    ...
    if (sprite.collide_rect(player1, enemy1) or sprite.collide_rect(player1, w1)
        or sprite.collide_rect(player1, w2) or sprite.collide_rect(player1, w3)
        or sprite.collide_rect(player1, w4)):
        finish = True
